...
import steveImage from '/Users/Heritier/Downloads/easyshoff/client/src/pages/steve1-removebg-preview.png'
import eliezerImage from '/Users/Heritier/Downloads/easyshoff/client/src/pages/Eliezer.png'
import princeImage from '/Users/Heritier/Downloads/easyshoff/client/src/pages/Prince.png'
    ...
    <div className=" min-h-screen">
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-5 md:grid-cols-3 gap-12">
            <TeamMember
                name="Steve Sebineza"
                role="CEO"
                image={steveImage}
